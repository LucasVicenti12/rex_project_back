package com.delice.crm.shared.economicActivities.domain.usecase.implementation

import com.delice.crm.core.utils.extensions.removeSpecialChars
import com.delice.crm.shared.economicActivities.domain.exceptions.ECONOMIC_ACTIVITY_UNEXPECTED_ERROR
import com.delice.crm.shared.economicActivities.domain.exceptions.INVALID_ECONOMIC_ACTIVITY
import com.delice.crm.shared.economicActivities.domain.exceptions.INVALID_ECONOMIC_ACTIVITY_NOT_FOUND
