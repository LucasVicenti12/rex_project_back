...
val NAME_MUST_BE_PROVIDED = UserException("NAME_MUST_BE_PROVIDED", "Name or surname must be provided")
val EMAIL_MUST_BE_PROVIDED = UserException("EMAIL_MUST_BE_PROVIDED", "Email must be provided")
