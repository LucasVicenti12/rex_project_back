package com.delice.crm.api.viaCep.domain.usecase.implementation

import com.delice.crm.core.utils.extensions.removeAlphaChars
import com.delice.crm.api.viaCep.domain.exceptions.ADDRESS_NOT_FOUND
import com.delice.crm.api.viaCep.domain.exceptions.ADDRESS_UNEXPECTED_ERROR
import com.delice.crm.api.viaCep.domain.exceptions.INVALID_ZIP_CODE
import com.delice.crm.api.viaCep.domain.repository.ViaCepRepository
